...
import com.github.devraghav.bugtracker.issue.dto.UpdateIssueRequest;
...
public class IssueMapperImpl implements IssueMapper {
    ...
    @Override
    public IssueEntity issueRequestToIssueEntity(CreateIssueRequest createIssueRequest) {
    ...
    @Override
    public IssueEntity issueRequestToIssueEntity(IssueEntity issueEntity, UpdateIssueRequest updateIssueRequest) {
