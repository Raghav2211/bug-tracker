...
class IssueUpdatedEventConverter
    implements EventConverter<IssueEvents.Updated, IssueUpdatedSchema> {
  ...
  @Override
  public IssueUpdatedSchema convert(IssueEvents.Updated event) {
