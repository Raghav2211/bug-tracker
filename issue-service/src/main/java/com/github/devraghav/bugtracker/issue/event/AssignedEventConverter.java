...
class AssignedEventConverter implements EventConverter<IssueEvents.Assigned, IssueAssignedSchema> {
  ...
  @Override
  public IssueAssignedSchema convert(IssueEvents.Assigned event) {
