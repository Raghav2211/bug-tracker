...
public interface ProjectResponse {
  ...
  static Mono<ServerResponse> retrieve(List<Project> projects) {
    return ServerResponse.ok()
        .contentType(MediaType.APPLICATION_JSON)
        .body(BodyInserters.fromValue(projects));
  }

  static Mono<ServerResponse> create(ServerRequest request, Project project) {
    return ServerResponse.created(URI.create(request.path() + "/" + project.id()))
        .body(BodyInserters.fromValue(project));
  }

  static Mono<ServerResponse> ok(Version version) {
  ...
  static Mono<ServerResponse> invalid(ServerRequest request, ProjectException exception) {
  ...
  static Mono<ServerResponse> notFound(ServerRequest request, ProjectException exception) {
  ...
  record Version(String id, String version, String userId) {}
}
